...
public: /* Types: */
    ...
    struct IlluminateResult {
        ...
        IlluminateResult(Colour radiance, Vector direction, floating distance,
                         floating directPdfW, floating emissionPdfW,
                         floating cosTheta)
            : radiance{radiance}
            , direction{direction}
            , distance{distance}
    ...
    struct RadianceResult {
        ...
        RadianceResult(Colour radiance, floating emissionPdfW,
                       floating directPdfA)
            : radiance{radiance}
            , emissionPdfW{emissionPdfW}
...
public: /* Methods: */
    explicit Light(const SceneSphere& sceneSphere, Colour intensity,
                   bool isFinite, bool isDelta)
