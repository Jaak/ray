...
public: /* Methods: */
    ...
    Spotlight(const SceneSphere& sceneSphere, Colour intensity, const Point& p,
              const Vector& d, floating a)
    ...
    virtual EmitResult emit() const override {
        ...
        return {intensity(), m_position, m_frame.normal(), dir, m_emissionPdfW,
                1.0,         1.0};
    }
